...
-- Database client (dbee) keybindings - Usando <leader>D para evitar conflictos con DAP
keymap("n", "<leader>Do", "<cmd>Dbee<cr>", vim.tbl_extend("force", opts, { desc = "Open Database UI" }))
